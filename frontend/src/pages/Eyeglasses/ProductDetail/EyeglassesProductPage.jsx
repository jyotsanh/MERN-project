...
import { FetchEyeglassesProductWithId, getCartItems, addToCart as apiAddToCart } from './../../../service/api';
  ...
  useEffect(() => {
    const fetchProductAndCartItems = async () => {
      try {
        ...
        const response = await FetchEyeglassesProductWithId(id);
...
export default EyeglassesProductPage;
