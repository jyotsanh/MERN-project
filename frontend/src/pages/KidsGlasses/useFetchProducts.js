...
import { FetchKidsglassesProductsUser, FetchFilteredProducts, FetchFilteredKidsglassesProducts } from '../../service/api';
      ...
      try {
        ...
        if (isFiltered) {
                ...
                if (Object.keys(nonEmptyFilters).length > 0) {
                  ...
                  productsData = await FetchFilteredKidsglassesProducts(nonEmptyFilters);
