...
import { FetchSunglassesProductWithId, getCartItems, addToCart as apiAddToCart } from './../../../service/api';
  ...
  useEffect(() => {
    const fetchProductAndCartItems = async () => {
      try {
        ...
        const response = await FetchSunglassesProductWithId(id);
...
export default SunglassesProductPage;
