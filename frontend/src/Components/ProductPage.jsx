...
import { FetchProductWithId, getCartItems, addToCart as apiAddToCart } 
  from '../service/api';
  ...
  return (
    <div className="pro-product-page">
      ...
      <div className="pro-product-details">
        ...
        <p><strong>Frame Material:</strong> {product.frame_material}</p>
        <p><strong>Lens Material:</strong> {product.lens_material}</p>
        <p><strong>Frame Shape:</strong> {product.frame_shape}</p>
